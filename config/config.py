...
__C.CLUSTERING.TARGET_DATASET_TYPE = 'SingleDataset'#'SingleDatasetWithoutLabel'
...
__C.CLUSTERING.TEMPERATURE = 0.2 
...
__C.VAT.EPS = 1.0
__C.VAT.IP = 1
__C.VAT.LOSS_WEIGHT = 1.0

##
__C.PROTOTYPE=edict()
__C.PROTOTYPE.ALPHA = 0.5
__C.PROTOTYPE.LOSS_WEIGHT = 0.0
##center loss in source
__C.PROTOTYPE.CENTER_WEIGHT = 1.0
__C.PROTOTYPE.CEN2CEN_WEIGHT = 1.0
__C.PROTOTYPE.CENTER_TGT_WEIGHT = 1.0
# Testing options
#
__C.SPNET=edict()
__C.SPNET.LOSS_INIT_THRESHOLD = 1.0
__C.SPNET.LOSS_THRESHOLD = 0.1
__C.SPNET.LOSS_FACTOR = 1.3
__C.SPNET.MAX_EPOCHS = 80
__C.SPNET.MAX_COUNT = 20
