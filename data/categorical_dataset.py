import os
from .image_folder import make_dataset_classwise
    ...
    def initialize(self, source_root, target_paths,
        ...
        for d in ['source', 'target']:
            ...
            for c in self.class_set:
                ...
                cur_size=len(self.data_paths[d][cid])
                if cur_size>max_size:
                    max_size=cur_size
                cid += 1
        self.max_dataset=max_size*len(self.class_set)
...
class CategoricalGEMSTDataset(Dataset):
    def __init__(self):
        super(CategoricalGEMSTDataset, self).__init__()

    def initialize(self, source_root, target_paths,
                   source_prob_model,target_prob_model,
                   classnames, class_set,
                   source_batch_size,
                   target_batch_size, seed=None,
                   transform=None, **kwargs):
